...
class VCExtendAddonClass {
    ...
    public function integrateWithVC()
    {
        ...
        vc_map( array(
            ...
            "class" => "",
            "controls" => "full",
            "icon" => HI_URL . 'functions/extension/vc/vc-image-ext/assets/hover_vc_icon_32x32.png', // or css class name which you can reffer in your css file later. Example: "vc_extend_my_class"
