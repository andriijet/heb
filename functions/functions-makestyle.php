	...
	function hi_render_tpl( $slug, $tpl_data, $assigns )
	{
		...
		if( $data->buttons->enable )
		{
			...
			if( $data->buttons->set->view )
			{
              ...
              $view = '<a href="' . HI_URL . 'assets/img/dummy.jpg" class="hi-ff-view hi-view-button' . $adClass . '" target="_blank"></a>';
			}
		...
		$output .= '<img src="' . HI_URL . 'assets/img/dummy.jpg" alt="Inani elitr apeirian" class="hi-tpl-image" />';
