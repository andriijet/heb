	...
	<div class="blockWrap">
		...
		<div class="tab-content">
            ...
            <div class="tab-pane hi-options-pane" id="hi-general-tab">
                <?php include( HI_PATH . 'templates/template-admin-options-tab-general.php' ); ?>
            </div><!-- // general-tab-pane -->

			<!-- image-tab-pane -->
			<div class="tab-pane hi-options-pane" id="hi-image-tab">
				<?php include( HI_PATH . 'templates/template-admin-options-tab-image.php' ); ?>
			</div><!-- // image-tab-pane -->

			<!-- overlay-tab -->
			<div class="tab-pane hi-options-pane" id="hi-overlay-tab">
				<?php include( HI_PATH . 'templates/template-admin-options-tab-overlay.php' ); ?>
			</div>
			<!-- end overlay-tab -->

			<!-- buttons-tab -->
			<div class="tab-pane hi-options-pane" id="hi-buttons-tab">
				<?php include( HI_PATH . 'templates/template-admin-options-tab-buttons.php' ); ?>
			</div>
			<!-- end buttons-tab -->

			<!-- content-tab -->
			<div class="tab-pane hi-options-pane" id="hi-content-tab">
				<?php include( HI_PATH . 'templates/template-admin-options-tab-content.php' ); ?>
			</div>
			<!-- end content-tab -->
