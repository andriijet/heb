<?php include( HI_PATH . 'options/buttons/options-buttons-main.php' ); ?>
...
<div class="tab-content">
	<div class="tab-pane hi-options-pane" id="hi-buttons-style-tab">
		<?php include( HI_PATH . 'options/buttons/options-buttons-style.php' ); ?>
	</div>
	<div class="tab-pane hi-options-pane" id="hi-buttons-fade-slide-tab">
		<?php include( HI_PATH . 'options/buttons/options-buttons-fade-slide.php' ); ?>
	</div>
	<div class="tab-pane hi-options-pane" id="hi-buttons-transform-tab">
		<?php include( HI_PATH . 'options/buttons/options-buttons-transform.php' ); ?>
	</div>
</div>

<?php include( HI_PATH . 'options/buttons/options-buttons-end.php' ); ?>