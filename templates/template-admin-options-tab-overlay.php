<?php include( HI_PATH . 'options/overlay/options-overlay-main.php' ); ?>
...
<div class="tab-content">
	<div class="tab-pane hi-options-pane" id="hi-overlay-style-tab">
		<?php include( HI_PATH . 'options/overlay/options-overlay-style.php' ); ?>
	</div>
	<div class="tab-pane hi-options-pane" id="hi-overlay-fade-slide-tab">
		<?php include( HI_PATH . 'options/overlay/options-overlay-fade-slide.php' ); ?>
	</div>
	<div class="tab-pane hi-options-pane" id="hi-overlay-transform-tab">
		<?php include( HI_PATH . 'options/overlay/options-overlay-transform.php' ); ?>
	</div>
</div>

<?php include( HI_PATH . 'options/overlay/options-overlay-end.php' ); ?>
