<div class="blockWrap">
	...
	<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
		<?php
			...
			$tpls = hi_get_option( HI_TEMPLATES );
			$assigns = hi_get_option( HI_ASSIGNS );

			include( HI_PATH . 'templates/template-usage-options-featured.php' );
			include( HI_PATH . 'templates/template-usage-options-shortcodes.php' );
            include( HI_PATH . 'templates/template-usage-options-excludes.php' );

			if( count( $hi_api ) )
			{
				include( HI_PATH . 'templates/template-usage-options-api.php' );
			}
		?>
	</div>
