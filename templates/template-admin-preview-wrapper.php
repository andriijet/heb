	...
	<div class="hi-wrap" id="hi-preview">
		<img src="<?php echo HI_URL ?>assets/img/dummy.jpg" alt="Inani elitr apeirian" id="hi-preview-image"/>
		<div class="hi-overlay" id="hi-preview-overlay"></div>
		<div id="hi-preview-buttons">
			<div id="hi-buttons">
				<a href="<?php echo HI_URL ?>assets/img/dummy.jpg" target="_blank" class="hi-ff-view hi-pb"></a>
				<a href="#" class="hi-ff-link"></a>
			</div>
		</div>
		<div id="hi-preview-content">
			<div id="hi-content">
				<a href="#" id="hi-content-title">Enim esse assentior</a>
				<p id="hi-content-excerpt">Purto eius labitur vel id. Duo an justo aperiri integre, vidit dicat docendi sed ex, has prima simul tempor te. Dolorum detracto eu pro, enim ubique pericula te cum, ei dicam commune eos. An has legere option platonem. Animal atomorum te nam, ne vix movet tantas dissentiet, vel esse impedit delicata ad. Cu nec eripuit atomorum, veri pertinacia concludaturque cu mei.
				...
				<div id="hi-content-share"><a target="_blank" data-color="#00ACED" class="hi-ff-twitter" href="#"></a
						><a target="_blank" data-color="#3B5998" class="hi-ff-facebook" href="#"></a
						><a target="_blank" data-color="#DD4B39" class="hi-ff-googleplus" href="#"></a
						><a target="_blank" data-color="#CB2027" class="hi-ff-pinterest" href="#"></a
						><a target="_blank" data-color="#2C4762" class="hi-ff-tumblr" href="#"></a
						><a target="_blank" data-color="#3399CC" class="hi-ff-linkedin" href="#"></a
						><a target="_blank" data-color="#ff5700" class="hi-ff-reddit" href="#"></a
						><a target="_blank" data-color="#0093CC" class="hi-ff-digg" href="#"></a>
				</div>
			</div><!-- // #hi-content -->
		</div><!-- // #hi-preview-content -->
	</div><!-- // #hi-wrap -->

<div class="blockWrap options-common-bottom">
	<?php include( HI_PATH . 'options/common/options-common-top.php' ); ?>
	<?php include( HI_PATH . 'options/common/options-common-bottom.php' ); ?>
</div>
