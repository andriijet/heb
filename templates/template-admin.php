			...
			<div class="col-xs-12">
				...
				<div class="tab-content">
					<div class="tab-pane" id="hi-templates-tab">
						<?php include( HI_PATH . 'templates/template-templates.php' ); ?>
					</div>

					<div class="tab-pane" id="hi-editor-tab">
						<?php include( HI_PATH . 'templates/template-admin-editor.php' ); ?>
					</div>

					<div class="tab-pane" id="hi-options-tab">
						<?php include( HI_PATH . 'templates/template-usage-options.php' ); ?>
					</div>
