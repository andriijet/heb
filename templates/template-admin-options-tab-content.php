<?php include( HI_PATH . 'options/content/options-content-main.php' ); ?>
...
<div class="tab-content">
	<div class="tab-pane hi-options-pane" id="hi-content-style-tab">
		<?php include( HI_PATH . 'options/content/options-content-style.php' ); ?>
	</div>
	<div class="tab-pane hi-options-pane" id="hi-content-fade-slide-tab">
		<?php include( HI_PATH . 'options/content/options-content-fade-slide.php' ); ?>
	</div>
	<div class="tab-pane hi-options-pane" id="hi-content-transform-tab">
		<?php include( HI_PATH . 'options/content/options-content-transform.php' ); ?>
	</div>
</div>

<?php include( HI_PATH . 'options/content/options-content-end.php' ); ?>